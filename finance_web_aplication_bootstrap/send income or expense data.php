...
try {
    ...
    if(isset($_POST['expenseAmout'])) {
        ...
        $expenseCategoryColumnName[0] = "id_categories"; $expenseCategoryColumnName[1] = "expense_categories"; $expenseCategoryColumnName[2] = "expense_category";
        $expensePaymentColumnName[0] = "id_payment"; $expensePaymentColumnName[1] = "expense_payment"; $expensePaymentColumnName[2] = "expense_payment_method";
