...
class Balance extends \Core\Model {
    ...
    public function getAllResults() {
        ...
        //var_dump($_SESSION['allResults']);
        // var_dump($expenseResults);
        // exit;
        //return $this;

    }

    public static function getResultsToShow() {

        if(isset($_SESSION['expenseResults'])) {

        $balanceData = $_SESSION['expenseResults'];
        unset($_SESSION['expenseResults']);
